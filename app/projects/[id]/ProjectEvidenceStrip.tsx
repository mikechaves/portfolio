        ...
        {media.map((item) => (
          <figure key={item.src} className="overflow-hidden rounded border border-zinc-800 bg-black/70">
            <button
              ...
              className="group relative flex min-h-56 w-full items-center justify-center overflow-hidden bg-black p-3 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
