...
const PROJECT_MEDIA_COPY: Record<string, Record<string, ProjectMediaCopy>> = {
  ...
  gaia: {
    "/projects/gaia/main-image.png": {
      label: "Spatial retail prototype",
      caption: "Primary XR retail interface exploring immersive Starbucks store operations.",
    },
    "/projects/gaia/how-might-we.png": {
      label: "Problem framing",
      caption: "Research artifact framing the spatial retail opportunity.",
      section: "situation",
    },
    "/projects/gaia/gaia-prototype.png": {
      label: "Prototype map",
      caption: "Interface prototype connecting spatial navigation, product context, and store operations.",
      section: "action",
    },
    "/projects/gaia/wireframes-3d.png": {
      label: "3D wireframes",
      caption: "Design artifact showing how the immersive interface moved from layout to spatial structure.",
      section: "action",
    },
    "/projects/gaia/vr-testing.png": {
      label: "VR testing",
      caption: "Testing evidence used to refine usability in the immersive store environment.",
      section: "action",
    },
    "/projects/gaia/gaia-lobby-2.png": {
      label: "Lobby environment",
      caption: "Spatial prototype environment showing the customer and employee-facing experience.",
      section: "result",
    },
    "/projects/gaia/gaia-store-overview.png": {
      label: "Store overview",
      caption: "Result artifact showing how the system frames operational context in an immersive view.",
      section: "result",
    },
  },
  geovoice: {
