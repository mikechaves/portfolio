...
// Import Canvas with dynamic import to avoid SSR issues
const Canvas = dynamic(() => import("@react-three/fiber").then((mod) => mod.Canvas), {
  ssr: false,
})

// Import our minimal scene
const MinimalStreetScene = dynamic(() => import("./minimal-street-scene"), {
  ssr: false,
})

export function MinimalMetaverseNav() {
