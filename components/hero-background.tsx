    ...
    const animate = () => {
      ...
      if (particlesRef.current) {
        ...
        particlesRef.current.rotation.y =
          time * 0.05 + mousePosition.current.x * 0.1;
        ...
        const sizes = particlesRef.current.geometry.attributes.size
          .array as Float32Array;
        const rotations = particlesRef.current.geometry.attributes.rotation
          .array as Float32Array;
      ...
      if (gridRef.current) {
        ...
        gridRef.current.rotation.x =
          Math.PI / 8 + Math.sin(time * 0.1) * (isMobile ? 0.03 : 0.05);
      }
